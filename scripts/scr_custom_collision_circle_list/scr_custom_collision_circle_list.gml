/// custom_collision_circle_list(x1,y1,radius,obj,prec,notme)
function scr_custom_collision_circle_list(argument0, argument1, argument2, argument3, argument4, argument5) {
	//
